...
namespace Explorer.API.Controllers.Author
{
    ...
    public class PublicEntityRequestController : BaseApiController
    {
        ...
        [HttpPut("{id:int}")]
        public ActionResult<PublicEntityRequestDto> Update([FromBody] PublicEntityRequestDto publicEntityRequestDto)
        {
            var result = _publicEntityRequestService.Update(publicEntityRequestDto);
            return CreateResponse(result);
        }
