...
namespace Explorer.Tours.Tests.Integration.Administration
{
    public class PublicEntityRequestCommandTest : BaseToursIntegrationTest
    {
        ...
        public void Approves_keypoint_request()
        {
            ...
            // Assert - Database
            var storedEntity = dbContext.PublicEntityRequests.FirstOrDefault(i => i.EntityId == acceptedRequest.EntityId && i.EntityType == Core.Domain.Enum.EntityType.KEYPOINT);
        ...
        public void Approves_object_request()
        {
            ...
            // Assert - Database
            var storedEntity = dbContext.PublicEntityRequests.FirstOrDefault(i => i.EntityId == acceptedRequest.EntityId && i.EntityType == Core.Domain.Enum.EntityType.OBJECT);
            storedEntity.ShouldNotBeNull();
            storedEntity.Id.ShouldBe(result.Id);
            storedEntity.Status.ShouldBe(Core.Domain.Enum.PublicEntityRequestStatus.APPROVED);
            ...
            objectToPublic.Status.ShouldBe(Core.Domain.Enum.ObjectStatus.PUBLIC);
        }
        ...
        public void Declines_request()
        {
            ...
            // Assert - Database
            var storedEntity = dbContext.PublicEntityRequests.FirstOrDefault(i => i.EntityId == declinedRequest.EntityId && i.EntityType == Core.Domain.Enum.EntityType.OBJECT);
            storedEntity.ShouldNotBeNull();
            storedEntity.Id.ShouldBe(result.Id);
            ...
            objectToPublic.ShouldNotBeNull();
            objectToPublic.Status.ShouldBe(Core.Domain.Enum.ObjectStatus.PRIVATE);
        }
