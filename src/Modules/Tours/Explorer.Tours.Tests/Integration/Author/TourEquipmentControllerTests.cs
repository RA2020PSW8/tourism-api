...
namespace Explorer.Tours.Tests.Integration.Author
{
    ...
    public class TourEquipmentControllerTests : BaseToursIntegrationTest
    {
        ...
        public void AddsEquipmentToTour()
        {
            ...
            // Assert - Database
            var storedEntity = dbContext.TourEquipments.FirstOrDefault(i => i.TourId == newEntity.TourId && i.EquipmentId == newEntity.EquipmentId);
        ...
        public void RemovesEquipmentFromTour()
        {
            ...
            // Assert - Database
            var deletedEntity = dbContext.TourEquipments.FirstOrDefault(i => i.TourId == entityToRemove.TourId && i.EquipmentId == entityToRemove.EquipmentId);
